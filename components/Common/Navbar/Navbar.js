          ...
          <Navbar collapseOnSelect expand="lg">
            <Container fluid className="container-width-2">
              ...
              <Navbar.Collapse id="basic-navbar-nav" in={isMenuOpen}>
                ...
                >
                  {navList.slice(0, 3).map((v, i) => {
                    return (
                      <Link
                        key={i}
                        href={v.href}
                        className={`nav-item relative ${
                          pathname === v.href ? "nav-active" : ""
                        }`}
                      >
                        {v.name}
                        <Image
                          src={animatedImage}
                          className=" h-full absolute nav-hover-image"
                          resizemode="contain"
                        />
                      </Link>
                    );
                  ...
                  <Link
                    ...
                    className={
                      pathname === "/case-study" ||
                      pathname === "/case-study/Zego" ||
                      pathname === "/case-study/Victek" ||
                      pathname === "/case-study/yummegurlo" ||
                      pathname === "/case-study/BookLover" ||
                      pathname === "/case-study/DreamShot" ||
                      pathname === "/case-study/orange-county" ||
                      pathname === "/case-study/Power_atm" ||
                      pathname === "/case-study/Speakable"
                        ? "nav-active relative nav-item"
                        : "relative nav-item"
                    }
                  >
                    Case study
                    <Image
                      src={animatedImage}
                      className="w-full h-full absolute  nav-hover-image "
                    />
                  </Link>
                  {navList.slice(3, 4).map((v, i) => {
                    return (
                      <Link
                        key={i}
                        href={v.href}
                  ...
                  <Link href={`tel:19173101802`}>+1 (917) 310-1802</Link>

                  <ReusableButton
                    buttonText="GET IN TOUCH"
                    onClick={() => router.push("/contact-us")}
                    additionalClasses="mt-0 nav-btn p-[10px] ml-2 "
                  />
                </Nav>
              </Navbar.Collapse>
              <Image
...
const SVGimage = () => {
  return (
    <div className="w-full h-full bg-transparent absolute top-[-8px] left-[-8px] box-content">
      {/* <div className="w-full h-full border-1 border-orange-400"></div> */}
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 133.38 52.35"
